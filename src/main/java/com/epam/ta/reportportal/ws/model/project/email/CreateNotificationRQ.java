...
public class CreateNotificationRQ implements Serializable {
	/**
	 * Generated SVUID
	 */
	private static final long serialVersionUID = -1647162176970115357L;
	...
	public CreateNotificationRQ() {
	}

	public CreateNotificationRQ(String ruleName, List<String> recs, String sendMode, List<String> laNames, Set<ItemAttributeResource> attributes, boolean enabled) {
	...
	public boolean equals(Object o) {
		...
		CreateNotificationRQ that = (CreateNotificationRQ) o;
