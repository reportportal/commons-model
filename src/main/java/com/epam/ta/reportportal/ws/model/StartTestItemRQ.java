...
public class StartTestItemRQ extends StartRQ {
  ...
  @In(allowedValues = {"suite", "story", "test", "scenario", "step", "before_class",
      "before_groups", "before_method", "before_suite",
  ...
  public boolean equals(Object o) {
    ...
    return hasStats == that.hasStats && Objects.equals(retryOf, that.retryOf) && Objects.equals(
        codeRef, that.codeRef)
        && Objects.equals(parameters, that.parameters) && Objects.equals(uniqueId, that.uniqueId)
        && Objects.equals(testCaseId,
        that.testCaseId
    ) && Objects.equals(launchUuid, that.launchUuid) && Objects.equals(type, that.type)
        && Objects.equals(retry, that.retry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), codeRef, parameters, uniqueId, testCaseId, launchUuid,
        type, retry, hasStats, retryOf);
  }

  @Override
  public String toString() {
    return "StartTestItemRQ{" + "codeRef='" + codeRef + '\'' + ", parameters=" + parameters
        + ", uniqueId='" + uniqueId + '\''
        + ", testCaseId='" + testCaseId + '\'' + ", launchUuid='" + launchUuid + '\'' + ", type='"
        + type + '\'' + ", retry="
  ...
  private static class UpperCaseTypeSerializer extends JsonSerializer<String> {
    ...
    @Override
    public void serialize(String type, JsonGenerator jsonGenerator,
