...
public class ServerEmailConfig implements Serializable {
	...
	public ServerEmailConfig(final String host, final int port, final String protocol, final boolean isAuth, final String username,
			final String password, final boolean debug) {
		this.host = host;
		this.port = port;
		this.protocol = protocol.toLowerCase();
		this.authEnabled = isAuth;
